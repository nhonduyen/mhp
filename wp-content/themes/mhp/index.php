            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <div class="property-content">
                        ...
                        <p class="location"><img src="<?php echo get_template_directory_uri(); ?>/img/icons/location.png" alt="">Upper Road 3411, no.34 CA</p>
...
<section class="call-to-action-area bg-fixed bg-overlay-black" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/bg-img/cta.jpg)">
